...
Welcome to `demo_e2e` contributor's guide.
...
If you experience bugs or general issues with `demo_e2e`, please have a look
...
You can help improve `demo_e2e` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`demo_e2e` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `demo_e2e`'s files. While this mechanism can
...
```
conda create -n demo_e2e python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/demo_e2e.git
   cd demo_e2e
   ```
...
5. Install [pre-commit]:
   ...
   `demo_e2e` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/demo_e2e
[issue tracker]: https://github.com/<USERNAME>/demo_e2e/issues
